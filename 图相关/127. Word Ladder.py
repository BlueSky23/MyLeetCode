        ...
        while q:
            ...
            for c in 'abcdefghijklmnopqrstuvwxyz':
                for i in range(len(tmp)):
                    ...
                    if word in wordList and distance[word] == sys.maxsize:
                        q.append(word)
                        distance[word] = distance[tmp] + 1
                        if word == endWord:
...
b = "sand"
e = "acne"
ls = ["slit", "bunk", "wars", "ping", "viva", "wynn", "wows", "irks", "gang", "pool", "mock", "fort", "heel", "send",
